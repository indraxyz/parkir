@extends('admin.layout') @section('title') Edit Tarif @endsection
@section('content')

<div class="w-full max-w-xl mx-auto mt-20">
    <form
        action="{{ url('admin/master/tarif-update') }}"
        method="post"
    ...
    >
        ...
        <h1 class="text-2xl mb-5 mt-8">Edit Tarif</h1>
